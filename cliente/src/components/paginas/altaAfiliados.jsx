...
const AltaAfiliados = () => {
    ...
    const handleClick = async (e) => {
        ...
        if (inputs.nombre.length===0 || inputs.apellido.length===0 || inputs.dni.length ===0 || inputs.email.length ===0) {
            ...
            await axios.post("https://gimnasioweb.herokuapp.com/altaAfiliados",inputs,config)
            setInputs({
                nombre: "",
                apellido: "",
                dni: 0,
            ...
            <Form onSubmit={handleClick}>
                <Row className="mt-0 pt-0">
                    <Form.Group controlId="formCabecera">
                        <hr></hr>
                            <h3 className="text-center mt-0 pt-0">ALTA DE AFILIADOS</h3>
                        <hr></hr>
                    </Form.Group>
                </Row>
